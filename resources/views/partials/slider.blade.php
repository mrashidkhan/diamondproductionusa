...
<div class="meeta-hero-section-6" style="background-image: url(assets/images/hero-6.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="meeta-hero-content text-center">
                    <p class="text" data-aos-delay="700" data-aos="fade-up">Best Event Organizer</p>
                    <h2 class="title" data-aos-delay="800" data-aos="fade-up">Diamond <br> <span>Productions USA</span></h2>
